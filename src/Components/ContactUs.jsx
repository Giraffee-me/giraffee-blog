  ...
  return (
    <section className=" py-[3rem]">
        <div className="w-smallSize sm:w-mainSize mx-auto">
            <div className=' mb-[2.5rem] sm:w-[500px] mx-auto'>
                <img src={mailPhoto} alt="aboutPhoto" className='w-full'/>
            </div>
            <div className='bg-white border-dashed border-[2px] border-black px-[1rem] py-[2rem] mt-[2rem]'>
                <div className="flex justify-center mb-[1rem]">
                    <div className="flex items-center gap-[.5rem] ">
                        ...
                        <h2 className="text-[2rem] font-bold ">يسعدني تواصلك معي عبر البريد الإلكتروني </h2>
